...
call Highlight("StatusLineBase", s:white, s:darker_grey, s:none)
call Highlight("StatusLineGitBranch", s:white, s:dark_grey, s:italic)
call Highlight("StatusLineModifiedFile", s:orange, s:darker_grey, s:none)
call Highlight("StatusLineReadOnlyFile", s:grey, s:darker_grey, s:none)
call Highlight("StatusLine", s:darker_grey, s:light_grey, s:none)
call Highlight("StatusLineSeparatorGitBranch", s:dark_grey, s:darker_grey, s:none)
call Highlight("StatusLineSeparatorNormalDark", s:light_green, s:dark_grey, s:none)
call Highlight("StatusLineSeparatorVisualDark", s:purple, s:dark_grey, s:none)
call Highlight("StatusLineSeparatorInsertDark", s:yellow, s:dark_grey, s:none)
call Highlight("StatusLineSeparatorCommandDark", s:light_blue, s:dark_grey, s:none)
call Highlight("StatusLineSeparatorNormal", s:light_green, s:darker_grey, s:none)
call Highlight("StatusLineSeparatorVisual", s:purple, s:darker_grey, s:none)
call Highlight("StatusLineSeparatorInsert", s:yellow, s:darker_grey, s:none)
call Highlight("StatusLineSeparatorCommand", s:light_blue, s:darker_grey, s:none)
call Highlight("StatusLineNormalMode", s:charcoal, s:light_green, s:bold)
call Highlight("StatusLineVisualMode", s:charcoal, s:purple, s:bold)
call Highlight("StatusLineInsertMode", s:charcoal, s:yellow, s:bold)
call Highlight("StatusLineCommandMode", s:charcoal, s:light_blue, s:bold)
